...
def parse_arguments():
    ...
    parser.add_argument("--start_date", type=str, default="2013-12-31", help="startdate")
    parser.add_argument("--path_to_file", type=str, default="./", help="startdate")
    parser.add_argument("--end_date", type=str, default="2014-12-31", help="enddate")
...
print(args)
stock_list = ['AAPL', 'AMAT', 'AJG', 'PG', 'VZ', 'MSFT', 'JNJ', 'V', 'MA', 
              'TRGP', 'OKE', 'SON', 'DVN', 'HD', 'INTC']
print(find_common_features(args, stock_list))
#AMZN, GOOGL, JLL
